                    ...
                    {orders?.map((order) => (
                      <TableRow key={order.id}>
                        <TableCell>
                          <Badge
                            variant={
                              order.urgency === "high" ? "destructive" : "default"
                            }
                          >
        ...
        <TabsContent value="deliveries">
          <Card>
            ...
            <CardContent className="h-96">
              {/* Intégrer ici la carte Leaflet avec positions des livreurs */}
              <div className="w-full h-full bg-gray-100 rounded-lg flex items-center justify-center">
                {/* Ex. : <DeliveryMap deliveries={deliveries || []} /> */}
        ...
        <TabsContent value="inventory">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Cette section est en cours d’implémentation
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p>Liste des produits, stocks, etc.</p>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
        ...
        <AlertDialog open={showOrderDialog} onOpenChange={setShowOrderDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Voulez-vous valider la commande de{" "}
                {selectedOrder.productName} pour {selectedOrder.client} ?
