...
namespace Digitalizer.DeliveryPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20250126013801_FixDeliveryPersonPhoneEmail")]
    partial class FixDeliveryPersonPhoneEmail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Digitalizer.DeliveryPlatform.Domain.Aggregates.Entities.DeliveryPerson", b =>
                {
                    ...
                    b.HasIndex("Email")
                        .IsUnique()
                        .HasDatabaseName("ix_delivery_person_email");

                    b.HasIndex("PhoneNumber")
                        .IsUnique()
                        .HasDatabaseName("ix_delivery_person_phone_number");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_delivery_person_status");
            ...
            modelBuilder.Entity("Digitalizer.DeliveryPlatform.Domain.Aggregates.Order.Order", b =>
                {
                    ...
                    b.HasIndex("AssignedDeliveryPersonId")
                        .HasDatabaseName("ix_order_assigned_delivery_person_id");
            ...
            modelBuilder.Entity("Digitalizer.DeliveryPlatform.Domain.Aggregates.Entities.DeliveryPerson", b =>
                {
                    b.OwnsOne("Digitalizer.DeliveryPlatform.Domain.Aggregates.Delivery.ValueObjects.Location", "CurrentLocation", b1 =>
                        {
            ...
            modelBuilder.Entity("Digitalizer.DeliveryPlatform.Domain.Aggregates.Order.Order", b =>
                {
                    b.HasOne("Digitalizer.DeliveryPlatform.Domain.Aggregates.Entities.DeliveryPerson", "AssignedDeliveryPerson")
